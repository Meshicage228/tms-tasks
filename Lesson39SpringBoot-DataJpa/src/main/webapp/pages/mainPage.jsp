...
<%@ taglib prefix="js" uri="http://www.springframework.org/tags" %>
...
<sf:form action="/home/save" method="post" modelAttribute="film">
    <div class="form-group">
        ...
        <sf:input path="title" type="title" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter film-title"/><sf:errors path="title"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <sf:input path="dateOfCreation" type="text" class="form-control" id="exampleInputPassword1" placeholder="Date of creation"/><sf:errors path="dateOfCreation"/>
    </div>
    <div class="form-group">
        <label for="exampleNumber">Write date of film creation</label>
        <sf:input path="rating" type="number" class="form-control" id="exampleNumber" placeholder="Rating from 0 to 10"/><sf:errors path="rating"/>
    </div>
